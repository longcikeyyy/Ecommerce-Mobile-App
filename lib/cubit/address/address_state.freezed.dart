...
mixin _$AddressState {
  ...
  List<AddressResponseModel> get addresses =>
...
class _$AddressStateImpl implements _AddressState {
  const _$AddressStateImpl({
    ...
    final List<AddressResponseModel> addresses = const [],
  ...
  final List<AddressResponseModel> _addresses;
  @override
  @JsonKey()
  List<AddressResponseModel> get addresses {
  ...
  @override
  String toString() {
    return 'AddressState(isLoading: $isLoading, isSaving: $isSaving, errorMessage: $errorMessage, isSaveSuccess: $isSaveSuccess, addresses: $addresses)';
  }
